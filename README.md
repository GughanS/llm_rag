...
| 1 | Transformer from scratch (~25-60M params) | 🟡 In progress |
| 2 | Triton fused attention kernel | ⬜ Not started |
| 3 | Distributed fine-tune with FSDP (TinyLlama-1.1B) | ⬜ Not started |
| 4 | DPO alignment | ⬜ Not started |
